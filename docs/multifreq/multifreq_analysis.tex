...
%% ==================================================================
\section{Overfitting in Single-Frequency Optimization}
%% ==================================================================
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.74\linewidth]{multifreq_sweep.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\linewidth]{bloch_cutoff2.5.jpg}
  \caption{Floquet--Bloch band structure analysis of the multifrequency-optimized
  $50 \times 50$ cell model. Best cloaking for these parameters corresponds to $f \approx 2.6$. IPR cutoff = 2.5. }
  \label{fig:bloch}
\end{figure}
