...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\linewidth]{multifreq_sweep.png}
  \caption{Frequency sweep of the multifrequency-optimized $50 \times 50$ cell model.
  Broadband cloaking is achieved by jointly optimizing displacement error
  across multiple training frequencies, eliminating the frequency-specific
  minima seen in single-frequency optimization.}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\linewidth]{bloch.jpg}
